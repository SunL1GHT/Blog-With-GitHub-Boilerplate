...
[link](https://ted2srt.org/talks/aaswath_raman_how_we_can_turn_the_cold_of_outer_space_into_a_renewable_resource) | [Bilibili Video ](https://www.bilibili.com/video/av44356598?p=1)

trillion、enormous、avert、in particular、ancient、ruin、evaporation蒸发、sill、surround、implausible、thermal热辐射、infrared红外线的、visualize、upward、molecule、micron微米、celsius、meteorologist、investigated研究、optica光学的、rooftop、at large详尽的、manufacture、boost、fluid、passively、condenser、underlying、solar、heat up、prob、conservation、conceptually、thermal、bathed、profoundly、coupled、intelligently、confront、marvel at、
